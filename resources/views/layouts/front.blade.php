                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown has-submenu">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Категории</a>
                            <ul class="dropdown-menu" aria-labelledby="dropdown02">
                                @foreach(App\Models\Category::where('parent_id', null)->get() as $category)
                                    <li>
                                        <a class="dropdown-item" href="">{{$category->name}} @if(count($category->children) > 0)<span class="hidden-md-down hidden-sm-down hidden-xs-down"><i class="fa fa-angle-right"></i></span> @endif</a>

                                        @if(count($category->children) > 0)
                                            @include('front.includes.categoryChild',['children' => $category->children])
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link color-pink-hover" href="blog-category-01.html">О нас</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-red-hover" href="blog-category-02.html">Контакты</a>
                        </li>
                    </ul>
                </div>
            </nav>
