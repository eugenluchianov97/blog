                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content mt-3" id="custom-tabs-five-tabContent">
                                ...
                                <div class="tab-pane fade" id="RO" role="tabpanel" >
                                    <div class="form-group">
                                        ...
                                        <input name="name_ro" type="text" class="form-control  @error('name_ro') is-invalid @enderror" placeholder="Название" value="{{ old('name') }}">
                                        @error('name_ro')<p class="text-danger">{{ $message }}</p> @enderror
                                    </div>

                                    <div class="form-group">
                                        <label>Описание<sup>RO</sup></label>
                                        <textarea name="description_ro" class="form-control @error('description_ro') is-invalid @enderror" rows="3" placeholder="Описание">{{ old('description') }}</textarea>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input name="slug" type="text" class="form-control  @error('slug') is-invalid @enderror" placeholder="Алиас" value="{{ old('slug') }}">
