...
@section('breadcrumbs')
    ...
    'items' => [
        ...
        ['title' => 'Создать','route' => route('admin.users.create'),'active' => false],
                    ...
                    <form action="{{route('admin.users.store')}}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control  @error('name') is-invalid @enderror" placeholder="Имя" value="{{ old('name') }}">
                                @error('name')<p class="text-danger">{{ $message }}</p> @enderror
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email <sup>*</sup></label>
                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Имя" value="{{ old('email') }}">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Пароль <sup>*</sup></label>
                                <input name="password" type="password" class="form-control @error('password') is-invalid @enderror"  placeholder="Пароль">
                                @error('password')<p class="text-danger">{{ $message }}</p> @enderror
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">Подтверждение пароля <sup>*</sup></label>
